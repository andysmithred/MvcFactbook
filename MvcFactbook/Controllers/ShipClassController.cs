...
namespace MvcFactbook.Controllers
{
    public class ShipClassController : FactbookController<ShipClass, ShipClassView>
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,SubClassName,Displacement,Length,Beam,Propulsion,Speed,Crew,Year,Complete")] ShipClass item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public override async Task<IActionResult> Edit(int id, [Bind("Id,Name,SubClassName,Displacement,Length,Beam,Propulsion,Speed,Crew,Year,Complete")] ShipClass item)
        {
