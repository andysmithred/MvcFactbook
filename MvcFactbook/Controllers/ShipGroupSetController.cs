    ...
    public class ShipGroupSetController : FactbookController<ShipGroupSet, ShipGroupSetView>
    {
        ...
        protected override Func<int, ShipGroupSet> GetItemFunction()
        {
            return i => Context
                        ...
                        .Include(x => x.ShipService).ThenInclude(x => x.ShipClass)
                        .Include(x => x.ShipService).ThenInclude(x => x.ShipSubType).ThenInclude(x => x.ShipType).ThenInclude(x => x.ShipCategory)
